...
def predict_model_comparation():
    ...
    model = load_model('static/MLModule/Alexnet.h5')
    ...
    modelh = load_model('static/MLModule/DenseNet201.h5')
...
def predict_select_image():
    ...
    model_dict = {
        'Alexnet'         :   'static/MLModule/Alexnet.h5',
        'DenseNet201'        :   'static/MLModule/DenseNet201.h5',
        }
